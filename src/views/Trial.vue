<template>
  ...
  >
    ...
    <aside
      class="transform top-0 left-0 w-screen bg-black fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
    ...
    >
      ...
      <div class="fixed bottom-0 w-full">
        ...
        >
          ...
          <span>Tell someone about us!</span>
        </button>
        <a
          rel="noopener"
